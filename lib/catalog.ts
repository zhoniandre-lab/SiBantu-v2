...
export const PRODUCTS: Product[] = [
  ...
  { id: 10, name: 'Ikan Nila', category: 'ikan', price: 25000, unit: 'kg', emoji: '🐟', step: 0.5, quickQuantities: [0.5, 1, 2], serviceOptions: ['Bersihkan ikan', 'Potong 2 bagian', 'Potong 4 bagian', 'Tidak dipotong'], aliases: ['nila', 'ikan nila'], stock: 12, description: 'Bisa dibersihkan sebelum dikirim.', badge: 'Terlaris' },
  { id: 11, name: 'Ikan Lele', category: 'ikan', price: 18000, unit: 'kg', emoji: '🐟', step: 0.5, quickQuantities: [0.5, 1, 2], serviceOptions: ['Bersihkan ikan', 'Potong 2 bagian', 'Potong 4 bagian', 'Tidak dipotong'], aliases: ['lele', 'ikan lele'], stock: 16, description: 'Segar, cocok digoreng atau dibakar.' },
  { id: 12, name: 'Ikan Tongkol', category: 'ikan', price: 44000, unit: 'kg', emoji: '🐠', step: 0.5, quickQuantities: [0.5, 1, 2], serviceOptions: ['Bersihkan ikan', 'Potong 2 bagian', 'Potong 4 bagian', 'Tidak dipotong'], aliases: ['tongkol', 'ikan tongkol'], stock: 9, description: 'Daging padat untuk gulai dan sambal.' },
  { id: 13, name: 'Ikan Bandeng', category: 'ikan', price: 28000, unit: 'kg', emoji: '🐟', step: 0.5, quickQuantities: [0.5, 1, 2], serviceOptions: ['Bersihkan ikan', 'Potong 2 bagian', 'Potong 4 bagian', 'Tidak dipotong'], aliases: ['bandeng', 'ikan bandeng'], stock: 8, description: 'Segar untuk presto atau bakar.' },

  { id: 20, name: 'Ayam Potong', category: 'daging', price: 45000, unit: 'kg', emoji: '🍗', step: 0.5, quickQuantities: [0.5, 1, 2], serviceOptions: ['Potong 4 bagian', 'Potong 8 bagian', 'Potong 12 bagian', 'Tidak dipotong'], aliases: ['ayam', 'ayam potong'], stock: 14, description: 'Dapat dipotong sesuai permintaan.', badge: 'Favorit' },
