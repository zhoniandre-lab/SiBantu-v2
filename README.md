...
| Moderasi | Toko dan produk harus disetujui admin |
...
- [ ] Upload 5 file Phase 2
- [ ] Vercel deployment Ready
- [ ] Test create product
- [ ] Test product pending moderation
- [ ] Buat admin product moderation
- [ ] Approve product
...
| Seller product/order API | ⏳ belum production |
